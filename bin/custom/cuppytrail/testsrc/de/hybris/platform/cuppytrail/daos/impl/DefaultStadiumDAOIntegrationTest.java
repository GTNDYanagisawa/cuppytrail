 ...
 *  *  * The purpose of this test is to illustrate DAO best practices and behaviour.  *  * The DAO logic is factored
 * into a separate POJO. Stepping into these will illustrate how to write and execute  * FlexibleSearchQueries - the
 * basis on which DAOs operate.  *  * @see "https://wiki.hybris.com/display/pm/Trail+~+DAOs"  
 */
